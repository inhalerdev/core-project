...
public final class Core extends JavaPlugin {
    ...
    public static final class Core extends JavaPlugin {

        private static net.mineacle.core.Core instance;
        ...
        public static net.mineacle.core.Core instance() {
            return instance;
        }
        ...
        public Module module(String name) {
            ...
            return moduleManager.module(name);
        }

        public TeleportService teleportService() {
            if (teleportService == null) {
                throw new IllegalStateException(
                        "TeleportService is not initialized"
                );
            }
