...
public final class MineaclePlaceholderExpansion extends PlaceholderExpansion {
    ...
    public @Nullable String onRequest(OfflinePlayer player, @NotNull String params) {
        ...
        return switch (key) {
            ...
            case "balance_raw", "money_raw" ->
                    MoneyFormatter.rawFromCents(economyService.getBalanceCents(uuid));
    ...
    private String globalStatsPlaceholder(String key, String type) {
        ...
        return switch (field) {
            ...
            case "value", "kills" -> type.equals("kills") ? String.valueOf(profile.kills()) : null;
    ...
    private String emptyStatValue(String field) {
        return switch (field) {
            case "name", "username", "player", "player_name", "displayname", "display_name",
                    "player_displayname", "player_display_name", "nickname", "nick",
                    "value", "kills", "deaths", "time", "playtime", "rank", "position",
                    "rank_raw", "position_raw" -> EMPTY_SLOT;
    ...
    private String globalBalTopPlaceholder(String key) {
        ...
        return switch (field) {
            ...
            case "balance_raw", "money_raw", "value_raw" ->
                    MoneyFormatter.rawFromCents(entry.cents());
            case "rank", "position" -> "#" + position;
            case "rank_raw", "position_raw" -> String.valueOf(position);
            default -> null;
        };
    ...
    private String emptyBalTopValue(String field) {
        return switch (field) {
            case "name", "username", "player", "player_name", "displayname", "display_name",
                    "player_displayname", "player_display_name", "nickname", "nick",
                    "balance", "balance_formatted", "money", "money_formatted", "value",
                    "value_formatted", "balance_full", "money_full", "value_full",
